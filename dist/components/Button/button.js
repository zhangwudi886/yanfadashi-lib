...
export var Button = function (props) {
    var _a;
    var btnType = props.btnType, size = props.size, disabled = props.disabled, href = props.href, className = props.className, children = props.children, restProps = __rest(props, ["btnType", "size", "disabled", "href", "className", "children"]);
